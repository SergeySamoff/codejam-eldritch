...
const isGreen1 = firstStageAzatoth.filter(firstStageAzatoth => firstStageAzatoth.color === 'green');
document.getElementById("green1Cards").innerHTML = isGreen1.length;

const isBrown1 = firstStageAzatoth.filter(firstStageAzatoth => firstStageAzatoth.color === 'brown');
document.getElementById("brown1Cards").innerHTML = isBrown1.length;

const isBlue1 = firstStageAzatoth.filter(firstStageAzatoth => firstStageAzatoth.color === 'blue');
document.getElementById("blue1Cards").innerHTML = isBlue1.length;

const Counter = function () {
    const isGreen1 = firstStageAzatoth.filter(firstStageAzatoth => firstStageAzatoth.color === 'green');
    this.count = isGreen1.length;
